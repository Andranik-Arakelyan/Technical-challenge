...
### TC-AUTH-UI-01 · Login with invalid credentials (UI)
| | |
|---|---|
...
### TC-AUTH-UI-02 · Login with empty fields (UI)
| | |
|---|---|
| **Preconditions** | User is on `/admin` |
...
### TC-AUTH-UI-03 · Login with valid credentials (UI)
| | |
|---|---|
| **Preconditions** | User is on `/admin` |
| **Steps** | 1. Enter valid username and password <br> 2. Click Login |
...
| **Expected** | Admin panel is no longer accessible; dashboard page appears |
| **Automated** | `tests/ui/auth.ui.spec.ts` |